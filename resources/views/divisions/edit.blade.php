                ...
                <div>
                    ...
                    <div class="flex gap-3 mt-1">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="visibility" value="public" {{ old('visibility', $division->visibility) === 'public' ? 'checked' : '' }} class="text-cyan-600 focus:ring-cyan-500">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="visibility" value="authenticated" {{ old('visibility', $division->visibility) === 'authenticated' ? 'checked' : '' }} class="text-cyan-600 focus:ring-cyan-500">
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-slate-700">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="requires_approval" value="1"
                            ...
                            {{ old('requires_approval', $division->requires_approval) ? 'checked' : '' }}>
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">Require approval for all uploads to this division</span>
                    </label>
                    <p class="mt-1 ml-7 text-xs text-slate-500 dark:text-slate-400">When enabled, any document uploaded to this division is held as "Pending Approval" until an approver reviews it.</p>
                </div>
                @endif
