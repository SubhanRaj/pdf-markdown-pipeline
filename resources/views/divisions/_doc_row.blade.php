...
<div class="flex items-start gap-3 px-5 py-3.5 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors group
    ...
    <div class="flex items-center gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
        <a href="{{ route('documents.divisions.show', [$department->levelAlias(), $department, $section, $division, $doc]) }}"
        ...
        <button type="button"
                ...
                data-action="{{ route('documents.divisions.destroy', [$department->levelAlias(), $department, $section, $division, $doc]) }}"
