...
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 px-6 py-14 text-center">
    <i class="ti ti-upload text-3xl text-slate-300 dark:text-slate-600"></i>
...
(function () {
    ...
    function setRowStatus(item, state, msg) {
        ...
        const labels = { pending: 'Pending', uploading: 'Uploading…', converting: 'Queued for OCR/conversion', done: '✓ Uploaded', error: '✗ Error' };
    ...
    function addFiles(files) {
        Array.from(files).forEach(file => {
            ...
            const item = { file, titleInput, titleWrap, errorLine, statusBadge, row };
